...
export function LocationIcon({ className, strokeWidth = 2 }: IconProps) {
  return (
    <svg
      className={cn('w-5 h-5', className)}
      fill="none"
...
export function CommentIcon({ className, strokeWidth = 2 }: IconProps) {
  return (
    <svg
...
export function BookIcon({ className, strokeWidth = 1.5 }: IconProps) {
  return (
    <svg
      className={cn('w-5 h-5', className)}
      fill="none"
