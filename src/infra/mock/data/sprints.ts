 ...
 *
 * Single source of truth for sprint competition data.
 * Migrated from features/sprint/data/sprints.ts
 */

// Import Season from its canonical location
import type { Season } from './seasons';

// Re-export Season for convenience
export type { Season } from './seasons';

// Sprint type - canonical definition
...
// Project type - canonical definition
...
const MOCK_AUTHORS = [
  { id: 'user-1', name: 'Alex Chen', avatar: 'https://api.dicebear.com/9.x/avataaars/png?seed=alex&top=shortHairShortFlat' },
  { id: 'user-2', name: 'Sarah Lin', avatar: 'https://api.dicebear.com/9.x/avataaars/png?seed=sarah&top=longHairStraight' },
  { id: 'user-3', name: 'Mike Wang', avatar: 'https://api.dicebear.com/9.x/avataaars/png?seed=mike&top=shortHairShortFlat' },
  { id: 'user-4', name: 'Emily Huang', avatar: 'https://api.dicebear.com/9.x/avataaars/png?seed=emily&top=longHairStraight' },
  { id: 'user-5', name: 'Kevin Liu', avatar: 'https://api.dicebear.com/9.x/avataaars/png?seed=kevin&top=shortHairShortFlat' },
  { id: 'user-6', name: 'Jenny Wu', avatar: 'https://api.dicebear.com/9.x/avataaars/png?seed=jenny&top=longHairStraight' },
  { id: 'user-7', name: 'David Lee', avatar: 'https://api.dicebear.com/9.x/avataaars/png?seed=david&top=shortHairShortFlat' },
  { id: 'user-8', name: 'Lisa Chang', avatar: 'https://api.dicebear.com/9.x/avataaars/png?seed=lisa&top=longHairStraight' },
  { id: 'user-9', name: 'Tom Yang', avatar: 'https://api.dicebear.com/9.x/avataaars/png?seed=tom&top=shortHairShortFlat' },
  { id: 'user-10', name: 'Amy Zhang', avatar: 'https://api.dicebear.com/9.x/avataaars/png?seed=amy&top=longHairStraight' },
  { id: 'user-11', name: 'Ryan Xu', avatar: 'https://api.dicebear.com/9.x/avataaars/png?seed=ryan&top=shortHairShortFlat' },
  { id: 'user-12', name: 'Nicole Tan', avatar: 'https://api.dicebear.com/9.x/avataaars/png?seed=nicole&top=longHairStraight' },
  { id: 'user-13', name: 'Jason Ma', avatar: 'https://api.dicebear.com/9.x/avataaars/png?seed=jason&top=shortHairShortFlat' },
  { id: 'user-14', name: 'Cathy Luo', avatar: 'https://api.dicebear.com/9.x/avataaars/png?seed=cathy&top=longHairStraight' },
  { id: 'user-15', name: 'Steve Zhou', avatar: 'https://api.dicebear.com/9.x/avataaars/png?seed=steve&top=shortHairShortFlat' },
  { id: 'user-16', name: 'Mia He', avatar: 'https://api.dicebear.com/9.x/avataaars/png?seed=mia&top=longHairStraight' },
  { id: 'user-17', name: 'Eric Sun', avatar: 'https://api.dicebear.com/9.x/avataaars/png?seed=eric&top=shortHairShortFlat' },
  { id: 'user-18', name: 'Olivia Feng', avatar: 'https://api.dicebear.com/9.x/avataaars/png?seed=olivia&top=longHairStraight' },
  { id: 'user-19', name: 'Chris Gao', avatar: 'https://api.dicebear.com/9.x/avataaars/png?seed=chris&top=shortHairShortFlat' },
  { id: 'user-20', name: 'Tina Ye', avatar: 'https://api.dicebear.com/9.x/avataaars/png?seed=tina&top=longHairStraight' },
  { id: 'user-21', name: 'Marcus Johnson', avatar: 'https://api.dicebear.com/9.x/avataaars/png?seed=marcus&top=shortHairShortFlat' },
  { id: 'user-22', name: 'Sophia Kim', avatar: 'https://api.dicebear.com/9.x/avataaars/png?seed=sophia&top=longHairStraight' },
  { id: 'user-23', name: 'Daniel Park', avatar: 'https://api.dicebear.com/9.x/avataaars/png?seed=daniel&top=shortHairShortFlat' },
  { id: 'user-24', name: 'Rachel Green', avatar: 'https://api.dicebear.com/9.x/avataaars/png?seed=rachel&top=longHairStraight' },
  { id: 'user-25', name: 'Andrew Scott', avatar: 'https://api.dicebear.com/9.x/avataaars/png?seed=andrew&top=shortHairShortFlat' },
  { id: 'user-26', name: 'Michelle Torres', avatar: 'https://api.dicebear.com/9.x/avataaars/png?seed=michelle&top=longHairStraight' },
  { id: 'user-27', name: 'Brandon Lee', avatar: 'https://api.dicebear.com/9.x/avataaars/png?seed=brandon&top=shortHairShortFlat' },
  { id: 'user-28', name: 'Jessica Wang', avatar: 'https://api.dicebear.com/9.x/avataaars/png?seed=jessica&top=longHairStraight' },
  { id: 'user-29', name: 'Tyler Chen', avatar: 'https://api.dicebear.com/9.x/avataaars/png?seed=tyler&top=shortHairShortFlat' },
  { id: 'user-30', name: 'Amanda Liu', avatar: 'https://api.dicebear.com/9.x/avataaars/png?seed=amanda&top=longHairStraight' },
];
...
export const MOCK_SPRINTS: Sprint[] = [
  // 2026 Q1
  { id: 'sprint-2026-q1-1', seasonId: 'season-2026-q1', title: 'AI Agents & Automation', description: 'Build autonomous AI agents that can perform complex tasks', theme: 'Agents', thumbnailUrl: 'https://images.unsplash.com/photo-1677442136019-21780ecad995?w=800', startDate: new Date('2026-01-01'), endDate: new Date('2026-03-31'), votingStartDate: new Date('2026-03-15'), projectCount: 8, isVotingOpen: true },
  { id: 'sprint-2026-q1-2', seasonId: 'season-2026-q1', title: 'Multimodal AI Apps', description: 'Create applications that combine text, image, and audio AI', theme: 'Multimodal', thumbnailUrl: 'https://images.unsplash.com/photo-1620712943543-bcc4688e7485?w=800', startDate: new Date('2026-01-01'), endDate: new Date('2026-03-31'), votingStartDate: new Date('2026-03-15'), projectCount: 6, isVotingOpen: false },
  // 2025 Q4
...
// ==================== TABLE ALIASES ====================
// For consistency with other Database tables

/** Alias for MOCK_SPRINTS */
export const SprintsTable = MOCK_SPRINTS;

/** Alias for MOCK_PROJECTS */
export const ProjectsTable = MOCK_PROJECTS;
