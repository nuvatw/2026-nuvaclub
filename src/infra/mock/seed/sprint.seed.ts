  ...
  db.projects.createMany([
    {
      ...
      visibilityChosenAt: new Date('2026-01-15'),
      rank: 1,
      isWinner: true,
    ...
    },
    {
      ...
      status: 'approved',
      visibility: 'sprint-public',
      visibilityAcknowledged: true,
      acknowledgedAt: new Date('2026-01-08'),
      rank: 2,
      isWinner: false,
    ...
    },
    {
      ...
      status: 'approved',
      visibility: 'nuvaclub-only',
      visibilityAcknowledged: true,
      acknowledgedAt: new Date('2026-01-05'),
      visibilityChosenAt: new Date('2026-01-10'),
      rank: 3,
      isWinner: false,
    ...
    },
    {
      ...
      visibility: 'public',
      visibilityAcknowledged: true,
      acknowledgedAt: new Date('2026-01-12'),
      visibilityChosenAt: new Date('2026-01-14'),
      isWinner: false,
