...
export async function seedUsers(db: MockDB): Promise<void> {
  ...
  db.users.createMany([
    ...
    // 12. Mia Huang - Paired with Sophia Wang
    {
      ...
      name: 'Mia Huang',
      avatar: 'https://api.dicebear.com/9.x/avataaars/png?seed=mia&top=longHairCurly',
    ...
    // 15. Noah Lin - Looking for Nunu
    {
      ...
      name: 'Noah Lin',
      avatar: 'https://api.dicebear.com/9.x/avataaars/png?seed=noah&top=shortHairDreads01',
    ...
    // 17. Zoe Wu - Paired with Eric Liu
    {
      ...
      name: 'Zoe Wu',
      avatar: 'https://api.dicebear.com/9.x/avataaars/png?seed=zoe&top=longHairStraight2',
    ...
    // 11. Ryan Chen - N5, Regular - Beginner mentor
    {
      ...
      name: 'Ryan Chen',
      avatar: 'https://api.dicebear.com/9.x/avataaars/png?seed=ryan&top=shortHairTheCaesar',
    ...
    // 14. Sophia Wang - N3, Verified - Product AI expert (Voyager)
    {
      ...
      name: 'Sophia Wang',
      avatar: 'https://api.dicebear.com/9.x/avataaars/png?seed=sophia&top=longHairNotTooLong',
    ...
    // 18. Eric Liu - N4, Regular - Full-stack mentor
    {
      ...
      name: 'Eric Liu',
      avatar: 'https://api.dicebear.com/9.x/avataaars/png?seed=eric&top=shortHairShortRound',
    ...
    // 13. Olivia Lee - New explorer
    {
      ...
      name: 'Olivia Lee',
      avatar: 'https://api.dicebear.com/9.x/avataaars/png?seed=olivia&top=longHairCurvy',
    ...
    // 16. Ethan Chen - Interested in becoming Nunu
    {
      ...
      name: 'Ethan Chen',
      avatar: 'https://api.dicebear.com/9.x/avataaars/png?seed=ethan&top=shortHairShortFlat',
    ...
    // 19. Hannah Zhang - New explorer
    {
      ...
      name: 'Hannah Zhang',
      avatar: 'https://api.dicebear.com/9.x/avataaars/png?seed=hannah&top=longHairFrida',
    ...
    // 20. Lucas Wang - New explorer
    {
      ...
      name: 'Lucas Wang',
      avatar: 'https://api.dicebear.com/9.x/avataaars/png?seed=lucas&top=shortHairTheCaesarSidePart',
