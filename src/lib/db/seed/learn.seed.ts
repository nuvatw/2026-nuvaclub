...
export async function seedLearn(db: MockDB): Promise<void> {
  ...
  db.lessons.createMany([
    // Course 1 lessons
    { id: 'l1-1', courseId: 'course-1', title: 'Course Introduction', duration: 300, videoUrl: '', order: 1, createdAt: now, updatedAt: now },
    { id: 'l1-2', courseId: 'course-1', title: 'AI Copywriting Fundamentals', duration: 900, videoUrl: '', order: 2, createdAt: now, updatedAt: now },
    { id: 'l1-3', courseId: 'course-1', title: 'Product Positioning Analysis', duration: 1200, videoUrl: '', order: 3, createdAt: now, updatedAt: now },
    // Course 2 lessons
    { id: 'l2-1', courseId: 'course-2', title: 'What is ChatGPT', duration: 600, videoUrl: '', order: 1, createdAt: now, updatedAt: now },
    { id: 'l2-2', courseId: 'course-2', title: 'Basic Operations Guide', duration: 800, videoUrl: '', order: 2, createdAt: now, updatedAt: now },
    // Course 3 lessons
    { id: 'l3-1', courseId: 'course-3', title: 'Image Generation Basics', duration: 500, videoUrl: '', order: 1, createdAt: now, updatedAt: now },
    { id: 'l3-2', courseId: 'course-3', title: 'Getting Started with Midjourney', duration: 1200, videoUrl: '', order: 2, createdAt: now, updatedAt: now },
    // Course 4 lessons
    { id: 'l4-1', courseId: 'course-4', title: 'Prompt Structure Fundamentals', duration: 600, videoUrl: '', order: 1, createdAt: now, updatedAt: now },
    { id: 'l4-2', courseId: 'course-4', title: 'Role Setting Techniques', duration: 900, videoUrl: '', order: 2, createdAt: now, updatedAt: now },
    // Course 5 lessons
    { id: 'l5-1', courseId: 'course-5', title: 'Introduction to Automation', duration: 400, videoUrl: '', order: 1, createdAt: now, updatedAt: now },
    { id: 'l5-2', courseId: 'course-5', title: 'Make.com Basics', duration: 1000, videoUrl: '', order: 2, createdAt: now, updatedAt: now },
    // Course 6 lessons
    { id: 'l6-1', courseId: 'course-6', title: 'Data Analysis Fundamentals', duration: 500, videoUrl: '', order: 1, createdAt: now, updatedAt: now },
    { id: 'l6-2', courseId: 'course-6', title: 'Excel + AI', duration: 700, videoUrl: '', order: 2, createdAt: now, updatedAt: now },
    // Course 7 lessons
    { id: 'l7-1', courseId: 'course-7', title: 'Project Overview', duration: 400, videoUrl: '', order: 1, createdAt: now, updatedAt: now },
    { id: 'l7-2', courseId: 'course-7', title: 'Requirements Analysis', duration: 800, videoUrl: '', order: 2, createdAt: now, updatedAt: now },
    // Course 8 lessons
    { id: 'l8-1', courseId: 'course-8', title: 'Content Strategy Planning', duration: 600, videoUrl: '', order: 1, createdAt: now, updatedAt: now },
    { id: 'l8-2', courseId: 'course-8', title: 'Blog Writing', duration: 1000, videoUrl: '', order: 2, createdAt: now, updatedAt: now },
  ]);
