 ...
 * Each level determines the maximum number of Vavas a Nunu can mentor
 */
export const NUNU_LEVELS: NunuLevelConfig[] = [
  {
    ...
    description: 'Entry level, can mentor 3 Vavas',
  },
  {
    level: 'N4',
    ...
    description: 'Mid-level mentor, can mentor 5 Vavas',
  },
  {
    level: 'N3',
    name: 'Senior Nunu',
    ...
    description: 'Advanced mentor, can mentor 10 Vavas',
  },
  {
    level: 'N2',
    name: 'Expert Nunu',
    ...
    description: 'Expert-level mentor, can mentor 30 Vavas',
  },
  {
    level: 'N1',
    name: 'Master Nunu',
    ...
    description: 'Highest level, can mentor 50 Vavas',
  },
];
